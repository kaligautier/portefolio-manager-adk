...
├-── Agent spécialiste en immobilier ? Si bessoin lui mettre un agent pour la location et un pour acheter        
    └── get_real_estate_from_bigquery 

├-── Agent spécialiste de l'analyse de porte feuille d'actions
    └── get_transaction_from_bigquery 
