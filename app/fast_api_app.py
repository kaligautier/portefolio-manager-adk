...
bucket_name = f"gs://{project_id}-porte-folio-manager-logs"
...
app.title = "porte-folio-manager"
app.description = "API for interacting with the Agent porte-folio-manager"
