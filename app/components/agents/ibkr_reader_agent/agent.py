...
from app.config.constants import (
    IBKR_READER_AGENT_DESCRIPTION,
    IBKR_READER_AGENT_INSTRUCTION,
)
from app.config.settings import settings


def create_agent() -> LlmAgent:
    """Factory function to create a new instance of IBKR Reader Agent."""
    return LlmAgent(
        name="ibkr_reader_agent",
        model=settings.MODEL,
        instruction=IBKR_READER_AGENT_INSTRUCTION,
        description=IBKR_READER_AGENT_DESCRIPTION,
        tools=[
            McpToolset(
